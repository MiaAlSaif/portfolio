...
import iteration from "../images/ent-wf.png";
      ...
      <div className="bodyContainer">
        <div className="contentBody">
          <section>
            ...
            <h3>Introduction</h3>
            <p>
              <span>Company:</span> Storyblocks, a subscription-based stock
              media company providing an unlimited library of royalty-free
            ...
            <p>
              ...
              heatmaps, internal sales and usage data, heuristic evaluations,
              user interviews, and calculated net promoter score.
            </p>
            <p>
              <span>Results:</span> Foundational paths on-site for key products
              and segments, which unlocked new opportunities for future growth.
              In addition to codifying institutional knowledge and learnings of
              said key Enterprise personas.
            </p>
          </section>
          <section>
            <h3>The Problem</h3>
            <p>
              ...
              presented several challenges blocking growth. Storyblocks
              Enterprise product page resided on a separate domain, which
              resulted in visibility, traceability, and testing issues. Customer
              feedback and collected analytics raised concerns surrounding
              licensing information presented to leads. In addition, there was
              an absence of direct paths targeting key user personas. The main
              motivator for this effort was the inability to meet quarterly key
              performance indicators [KPI's], which negatively impacted both the
          ...
          <section>
            ...
            <p>
              ...
              understanding of both Enterprise and Standard license customers
              for the purpose of creating an Enterprise Value Proposition that
              excites our core customers. The plan was to accomplish this
              through ongoing quantitative and qualitative methods, together
              with collecting segmented Net Promoter Score. I started by
              engaging in interviews with 19 of Storyblocks Enterprise closed
              win/lost clients, along with recording key data from numerous
              sales call opportunities on the following:
            </p>
            <ul>
            ...
            <p>
              Next, I proceeded to review both Google Analytics and internal
              sales and usage data. In addition to investigating visibility
              issues through heuristic evaluations, and conducting further user
            ...
            <ul>
              ...
              <li>
                Lack of Storyblocks Enterprise visibility on the main site
              </li>
              <li>
            ...
            <p>
              To aid the process of identifying, learning about, and focusing on
              high value customer segments we ran a mandatory post-signup
              persona survey targeting all users, for several weeks.
            </p>
            ...
            <p>
              ...
              YouTube. Survey also revealed, in-house and production house
              editors make up two of our highest average PTC segments. Together,
              they account for a relatively high percentage [redacted value] of
              our Standard license users for video media. This validated one
              hypothesis around licensing confusion, where some customers failed
              to select the legal coverage necessary for their usage. Finally,
              to no surprise, data showed that professional users are preferable
          ...
          <section>
            ...
            <ul>
              ...
              <ul>
                ...
                <li>
                  Production companies (e.g. NBC, Amazon Studios, History
                  Channel, A&E)
                </li>
                <li>
                ...
                <li>
                  API Clients (e.g. Prezi, Biteable, Moovly, Softcube,
                  Vistaprint, WeVideo, Powtoon, Lightricks)
                </li>
              </ul>
              <p>
              ...
              <li>
                I was able to identify areas of opportunity to improve
                visibility on the main site, such as top navigation, footer,
                migrating Enterprise landing page onto the main domain, user
                account page, and leveraging Intercom to deliver targeted
                messaging
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              ...
              hypotheses on pain points and began working towards validating
              each through A/B testing and examining analytics from Hotjar
            ...
            <p>
              ...
              from our Standard licensing while staying true to the overall
              brand identity. Along with that effort, I also worked to design
              and document these personas for internal usage.
            </p>
            <span>
              Whiteboarding session to brainstorm persona template ideas
            </span>
            <div className="img-bg">
              <img alt="whiteboard" src={whiteboard} />
            </div>
            <span>
              Early layout wireframes for Enterprise external persona pages
            </span>
            ...
            <p>
              ...
              Storyblock top navigation. Some of these options were adapted to
              the current navigation, and some offered a vision for the future
            </p>
            <div className="img-bg">
            ...
            <p>
              ...
              Business Solutions, which linked to the Enterprise landing page
              and four new targeted pages catering to each persona.
            </p>
            <p>
            ...
            <ul>
              ...
              <li>
                ...
                component-based reusable templates customized to target
                identified personas
              </li>
              <li>
                Integrated Business Solutions in the global top navigation bar
                and footer
              </li>
              <div className="img-bg">
                {" "}
              ...
              <li>
                ...
                together with segmentation data internally [values and
                information redacted from sample below]
              </li>
              <div className="img-bg">
          ...
          <section>
            ...
            <ul>
              ...
              <ul>
                <li>
                  Enterprise microsite averaged ~1,050 unique page views per
                  week, while all four enterprise pages averaged ~1,400.
                </li>
              </ul>
            ...
            <ul>
              <li>
                This effort unlocked the ability to better understand
                visitor/lead on-site behavior
              </li>
              <ul>
                <li>
                  <span>Prior:</span> Cross-site tracking is poor to
                  non-existent due to cross-domain tracking to WordPress being
                  unreliable
                </li>
                <li>
                  <span>After:</span> Lead capture page is on the core domain
                  and using the same framework for tracking. This served us in
                  better understanding what Enterprise visitors and leads are
                  doing on-site (e.g. what pages they visit and what content
              ...
              <ul>
                <li>
                  <span>Prior:</span> Could not run tests on WordPress,
                  presenting difficulties in optimization
                </li>
                <li>
                  <span>After:</span>
                </li>
