      ...
      <div className="bodyContainer">
        <div className="contentBody">
          <section>
            ...
            <p>
              <span>Overview:</span> Storyblocks provides businesses and
              creators with unlimited stock media and flexible licensing via a
              flat pricing subscription model. This effort involved researching
              and designing a unified experience representing all stock media
              types, as well as, consistent visuals for Storyblocks Home and
              About Us pages.
            </p>
            <p>
              <span>Challenge:</span> Storyblocks various media types fell under
              separate domains and did not offer a unified experience to
              visitors and users alike. This presented usability, traceability,
              and testing challenges, as well as, brand identity issues. An
              observed plateau of All Access plans and mix plan signups further
              validated the need for this redesign.
            </p>
            <p>
              <span>Approach:</span> Google analytics, Hotjar recordings and
              heatmaps, internal sales and usage data, heuristic evaluations,
              user interviews, preference testing, A/B Testing, and calculated
              net promoter score.
            </p>
            <p>
              ...
              generated paths to learnings along with a long term unified
              approach to Plans and Pricing.
            </p>
          </section>
          <section>
            <h3>The Problem</h3>
          ...
          <section>
            ...
            <p>
              Utilizing data collected from Google Analytics and user
              interviews, we determined the following to be the core tasks for
              the Storyblocks One Site initiative:
            </p>
            <ul>
              <li>
              ...
              <li>
                Reduce friction and provide a more effective path to viewing
                Plans & Pricing (P&P) by streamlining access to selecting
                media-specific plans, as well as, All Access. This, in turn,
                will unlock new learnings and offer a long-term unified P&P
                solution
              </li>
              <li>
              ...
              <li>
                Improve SEO through seamless design to increase search ranking
                on monitored essential terms
              </li>
            </ul>
            <p>
              ...
              competitors. This allowed me to build up a better body of
              knowledge and identify several areas of opportunity for growth and
              differentiation.
            </p>
            <p>
              ...
              specialist, we set out to produce copy that aligns with
              Storyblock’s identity and voice. Including individuals from
              different departments, enabled me to approach the design process
              in a collective and detailed manner.
            </p>
            <p>
            ...
            <ul>
              ...
              <li>
                Who is Storyblocks, to establish a human connection with
                visitors
              </li>
          ...
          <section>
            ...
            <p>
              ...
              most effective designs, which I then transformed into
              high-fidelity prototypes using Sketch and Invision. Then,
              employing Usability Hub and Validately, we conducted preference
              testing to collect quantitative and qualitative data on which
              design participants preferred and why. The test began by
              presenting a participant with both prototypes side-by-side,
              leading to a series of questions that would help us understand the
              why and what behind their choice.
            </p>
            <p>
