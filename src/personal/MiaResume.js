          ...
          <section>
            ...
            <div className="job-desc">
              ...
              <ul>
                <li>
                  ...
                  Enterprise offering; designed and launched tailored
                  experiences that correlated to a 48% growth of qualified leads
                </li>
                <li>
                  Redesigned Storyblocks landing and About Us pages as part of
                  an initiative to consolidate products and deliver a unified
                  experience
                </li>
                <li>
                  Redesigned mobile and desktop experiences for SEO
                  optimization, resulting in improved performance and ranking on
                  Google for numerous identified search terms
                </li>
                <li>
                ...
                <li>
                  Maintained and contributed to Storyblocks design system and
                  team operations
                </li>
              </ul>
            </div>
            <div className="job-desc">
              ...
              <ul>
                ...
                <li>
                  Designed and launched Swarm, a product that resulted in
                  improved global teams’ velocity and contractual service level
                  agreement attainment
                </li>
                <li>
                  Served as subject-matter expert during client advisory calls
                  on development best practices, performance tuning, and
                  infrastructure architecture
                </li>
                <li>
                  Mentored and trained support engineers on job functions, as
                  well as complex client issues
                </li>
              </ul>
            ...
            <div className="job-desc">
              ...
              <ul>
                <li>
                  ...
                  contributed to an increase in the number of services provided
                  to over 157,667 classes in ten classroom buildings
                </li>
                <li>
                  Identified opportunities for improved internal and external
                  user experiences; expanded Classroom Educational Technology
                  Services [CETS] scheduling system functionalities and services
                </li>
                <li>
                  Owned all aspect of CETS homepage, including copywriting,
